				...
				<div class="tab-pane fade" id="members">
					...
					<div class="contacts">
						...
						<div class="list-group" id="contacts" role="tablist">
							...
							<a href="#" class="filterMembers all @if($user->isOnline) online @else offline @endif contact" data-toggle="list">
								...
								<div class="status">
									<i class="material-icons  @if($user->isOnline) online @else offline @endif">fiber_manual_record</i>
								</div>
								<div class="data">
									<h5>{{$user->name}}</h5>
									<p>Sofia, Bulgaria</p>
